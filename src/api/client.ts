...
const apiClient = create({
   baseURL: process.env.NODE_ENV === "development" ? 'http://192.168.1.17:8080/shareskillsapi/v1' : 'http://LB-PronosAPI-193411774.eu-west-3.elb.amazonaws.com/shareskillsapi/v1',
   timeout: 30000,
   headers: {
